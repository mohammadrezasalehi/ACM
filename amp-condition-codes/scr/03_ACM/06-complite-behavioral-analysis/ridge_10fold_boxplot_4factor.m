...
behav_file = fullfile(project_root, 'data', 'bihavioral', 'scores', 'scores_04.csv');  % Your behavior file
...
function plot_cpm_boxplots(R_Dist, models, factor_names, tit)
    figure('Color', 'w', 'Position', [50, 50, 1200, 800], 'Name', tit); % ??? ??? ?? ???? ???? (1200)
    ...
    for f = 1:n_factors
        ...
        for k = 1:1
            ...
            pos(2) = pos(2) - 0.01;   % move downward
            pos(4) = pos(4) * 0.93;   % slightly reduce height
