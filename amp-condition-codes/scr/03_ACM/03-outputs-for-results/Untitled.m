...
plot_row_on_surf(1, 4, NodeFeatures.Var_Mean, sr, sl, gr, gl,  {'Variance Modulatory', 'Impact'}, turbo);
...
plot_row_on_surf(2, 4, NodeFeatures.Slope_Polarity, sr, sl, gr, gl, {'Slope (Directional)', 'Impact'}, turbo);
...
plot_row_on_surf(3, 4, NodeFeatures.ZCR_Mean, sr, sl, gr, gl, {'ZCR Impact', ''}, turbo);
...
plot_row_on_surf(4, 4, NodeFeatures.Poly_Footprint, sr, sl, gr, gl, {'Non-Linear Footprint', '(Mean Prevalence)'}, turbo);
