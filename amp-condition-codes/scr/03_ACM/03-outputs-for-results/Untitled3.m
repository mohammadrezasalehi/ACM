...
slope_abs_mean  = mean((t_mat), 2, 'omitnan');
...
figure('Name', 'Variance Modulatory Impact', 'Position', [150, 150, 600, 500], 'Color', 'w');
sgtitle(['Variance Sensitivity (' display_level ' Level)'], 'FontSize', 16, 'FontWeight', 'bold');
plot_subplot(1, 1, 1, map_v_mean, '', labels);
...
figure('Name', 'Slope (Directional) Impact', 'Position', [150, 150, 600, 500], 'Color', 'w');
...
plot_subplot(1, 1, 1, map_s_abs, '', labels);

% --- Figure 3: ZCR/MCR Metric ---
figure('Name', 'ZCR/MCR Impact', 'Position', [150, 150, 600, 500], 'Color', 'w');
sgtitle(['ZCR Volatility (' display_level ' Level)'], 'FontSize', 16, 'FontWeight', 'bold');
plot_subplot(1, 1, 1, map_z_mean, '', labels);
