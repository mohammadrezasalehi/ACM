%% Suggested Name: run_ridge_10fold_boxplot.m
...
% Save Y_all
fprintf('\nSaving Y_all Vector...\n');
save_path_y_all = fullfile(project_root, 'results', 'Modulated_FC', 'Aggregated_Features', 'y_all.mat');
save(save_path_y_all, 'Y_all');
fprintf('Y_all saved successfully to:\n%s\n', save_path_y_all);
