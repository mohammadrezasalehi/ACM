...
base_result_dir = fullfile(project_root, 'results', 'Modulated_FC', 'retest');
...
save(fullfile(out_dir_node, 'RetestSubjs_Node_Features.mat'), 'feat_node_var', 'feat_node_slope', 'feat_node_zcr', 'feat_node_poly');
save(fullfile(out_dir_net, 'RetestSubjs_Net_Features.mat'), 'feat_net_var', 'feat_net_slope', 'feat_net_zcr', 'feat_net_poly');
